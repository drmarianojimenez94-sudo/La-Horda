...
function seedSave(opts = {}) {
  ...
  const save = { champions:{}, gold: opts.gold ?? 500, gems:0, playtestV1Bonus: opts.bonus ?? true, campaignResetV1:true, campaignResetV2:true, campaignResetV3:true, testStageV1:true, starterChosen:true, divineArenaUnlocked: opts.divina ?? true, itemSchemaV:2,
    arenasCleared: opts.cleared || {bosque:true,acuatica:true,fortaleza:true,micelial:true,hielo:true,laberinto:true,infernal:true}, relics:{hp:0,dmg:0,def:0,vel:0} };
