...
function seedSave(opts = {}) {
  ...
  const save = { champions:{}, gold: opts.gold ?? 500, gems:0, playtestV1Bonus: opts.bonus ?? true, campaignResetV1:true, campaignResetV2:true, starterChosen:true, divineArenaUnlocked: opts.divina ?? true, itemSchemaV:2,
